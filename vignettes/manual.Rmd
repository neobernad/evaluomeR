...
set.seed(100)
stabilityData <- stabilityRange(data=ontMetrics, k.range=c(2,4), bs=20, getImages = FALSE)
set.seed(100)
qualityData <- qualityRange(data=ontMetrics, k.range=c(2,4), getImages = FALSE)
...
We provide a series of methods for a further analysis on the metrics. These methods are: `plotMetricsMinMax`, `plotMetricsBoxplot` and `plotMetricsCluster`.
...
And finally, the `plotMetricsCluster` function clusters the values of the metrics by 
